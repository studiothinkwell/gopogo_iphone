...
- (void)dialogDidSucceed:(NSURL*)url {
	...
	printf("aaaaa");
	// set value for extended permission dialog..
	[[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"extend_permission_yes"];
